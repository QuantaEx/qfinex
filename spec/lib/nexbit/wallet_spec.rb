describe Nexbit::Wallet do
  let(:wallet) { Nexbit::Wallet.new }
  ...
  context :configure do
    ...
    it 'sets settings attribute' do
      ...
      expect(wallet.settings).to eq(settings.slice(*Nexbit::Wallet::SUPPORTED_SETTINGS))
    end
  end
  ...
  context :create_address! do
    ...
    let(:uri) { 'http://user:password@127.0.0.1:23519' }
    let(:uri_without_authority) { 'http://127.0.0.1:23519' }
