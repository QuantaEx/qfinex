      ...
      class Currencies < Grape::API
        ...
        helpers do
          ...
          OPTIONAL_CURRENCY_PARAMS = {
            ...
            cmc_link: { desc: -> { API::V2::Admin::Entities::Currency.documentation[:cmc_link][:desc] } },
            coin_gecko_link: { desc: -> { API::V2::Admin::Entities::Currency.documentation[:coin_gecko_link][:desc] } }
          }
